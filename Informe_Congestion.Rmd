...
<!-- En este modelo existen varias posibles etapas para un individuo: no infectado, infectado, hospitalizado... La transición entre etapas venía dada por variables fijas (probabilidad de pasar del hospital a UCI), pero en esta línea se consiguen adaptar los datos gallegos de SIVIES para encontrar estas probabilidades de una manera dinámica. -->
