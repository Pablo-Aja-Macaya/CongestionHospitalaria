...
source('../common/filter_outliers.R')
                ...
                bsCollapse(id = "collapseExample", open = "Panel 2",
                           ...
                           bsCollapsePanel(
                               ...
                               selectInput("area.sanitaria",
                                           ...
                                           selected = "Coruña - Cee", multiple = TRUE
                               ),
...
server <- function(input, output, session) {
    ...
    analisis.capacidad <- observe({
        ...
        capacidades$hospitales <- hospitales
        capacidades$unidades <- unidades
    ...
    analisis.capacidad.conjunto <- reactive({
        ...
        res <- plot.merged.capacity(capacidad, 
